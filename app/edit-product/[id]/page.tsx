...
export default function EditProductPage() {
  ...
  return (
    <main className={`${syne.variable} ${dmSans.variable}`} style={{ minHeight:"100vh", background:BG, fontFamily:"var(--font-dm-sans),'Helvetica Neue',system-ui,sans-serif", color:TEXT, paddingBottom:60 }}>
      <style>{`
