...
export default function BuyerAnalyticsPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: BG, padding: "32px", fontFamily: "'DM Sans','Helvetica Neue',system-ui,sans-serif" }}>
      ...
      <div style={{ maxWidth: 1000, margin: "0 auto" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 24 }}>
          <div>
            ...
            <h1 style={{ fontFamily: "'Syne',sans-serif", fontWeight: 800, fontSize: 26, color: TEXT, letterSpacing: "-0.8px", marginTop: 6 }}>Meine Einkaufsanalyse</h1>
          </div>
        </div>
        ...
        <div style={{ background: SURFACE, border: `1px solid ${BORDER}`, borderRadius: 18, padding: "22px", marginBottom: 20 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
            <div>
              <h2 style={{ fontFamily: "'Syne',sans-serif", fontWeight: 800, fontSize: 16, color: TEXT }}>Ausgabenverlauf</h2>
          ...
          {hasData && (
            <div style={{ display: "flex", gap: 24, marginTop: 16, paddingTop: 16, borderTop: `1px solid ${BORDER}` }}>
              <div>
                ...
                <p style={{ fontFamily: "'Syne',sans-serif", fontWeight: 800, fontSize: 16, color: TEXT }}>€{avgOrderValue.toFixed(2)}</p>
              </div>
              <div style={{ width: 1, background: BORDER }} />
              <div>
                <p style={{ fontSize: 11, color: TEXT3, marginBottom: 3 }}>Ø MONATLICH</p>
                <p style={{ fontFamily: "'Syne',sans-serif", fontWeight: 800, fontSize: 16, color: TEXT }}>€{(totalSpend / 12).toFixed(0)}</p>
              </div>
              <div style={{ width: 1, background: BORDER }} />
              <div>
                <p style={{ fontSize: 11, color: TEXT3, marginBottom: 3 }}>DIESEN MONAT</p>
                <p style={{ fontFamily: "'Syne',sans-serif", fontWeight: 800, fontSize: 16, color: ORANGE }}>€{spendThisMonth.toFixed(0)}</p>
              </div>
            </div>
          )}
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20, marginBottom: 20 }}>
          <div style={{ background: SURFACE, border: `1px solid ${BORDER}`, borderRadius: 18, padding: "22px" }}>
            <h2 style={{ fontFamily: "'Syne',sans-serif", fontWeight: 800, fontSize: 16, color: TEXT, marginBottom: 20 }}>Meistgekaufte Produkte</h2>
          ...
          <div style={{ background: SURFACE, border: `1px solid ${BORDER}`, borderRadius: 18, padding: "22px" }}>
            <h2 style={{ fontFamily: "'Syne',sans-serif", fontWeight: 800, fontSize: 16, color: TEXT, marginBottom: 20 }}>Top Lieferanten</h2>
