    ...
    <div style={{ padding: "32px 32px 60px", fontFamily: "'DM Sans','Helvetica Neue',system-ui,sans-serif" }}>
      ...
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 28 }}>
        <div>
          ...
          <h1 style={{ fontFamily: "'Syne',sans-serif", fontWeight: 800, fontSize: 26, color: TEXT, letterSpacing: "-0.8px" }}>Meine Produkte</h1>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 14, marginBottom: 24 }}>
        {[
          ...
          <div key={s.label} style={{ background: SURFACE, border: `1.5px solid ${s.warn ? ORANGE : BORDER}`, borderRadius: 14, padding: "18px" }}>
            ...
            <p style={{ fontFamily: "'Syne',sans-serif", fontWeight: 800, fontSize: 22, color: s.warn ? ORANGE : TEXT, margin: "10px 0 2px", letterSpacing: "-0.5px" }}>{s.value}</p>
          ...
          {filtered.map((product, i) => {
            ...
            return (
              <div key={product.id}
                ...
                {/* Price */}
                <p style={{ fontFamily: "'Syne',sans-serif", fontWeight: 800, fontSize: 15, color: TEXT }}>€{product.price.toFixed(2)}</p>
