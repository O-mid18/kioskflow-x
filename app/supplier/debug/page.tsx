...
export default function DebugPage() {
  ...
  return (
    <main style={{ padding: 40, fontFamily: "monospace", fontSize: 13 }}>
      <h1 style={{ marginBottom: 20 }}>Debug Info</h1>
      <pre style={{ background: "#111", color: "#0f0", padding: 20, borderRadius: 10, overflow: "auto" }}>
        {JSON.stringify(info, null, 2)}
      </pre>
      <a href="/supplier/dashboard" style={{ display: "inline-block", marginTop: 20, color: "blue" }}>
        → Go to Dashboard
      </a>
    </main>
  );
