...
export default function HomePage() {
  return (
    <main id="main-content" style={{ background: "var(--kf-bg)", backgroundImage: "radial-gradient(ellipse 55% 45% at 80% 12%, rgba(0,62,199,0.07) 0%, transparent 65%)", color: "var(--kf-text)", fontFamily: "'Inter','Helvetica Neue',system-ui,sans-serif", overflowX: "hidden" }}>
      ...
      <nav role="navigation" aria-label="Hauptnavigation" style={{ position: "sticky", top: 0, zIndex: 50, background: "var(--kf-surface)", borderBottom: "1px solid var(--kf-border)", padding: "0 32px", height: 60, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <div className="kf-desktop-auth" style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <a href="/signup" className="kf-cta-btn" style={{ background: ORANGE, color: "#fff", fontSize: 14, fontWeight: 700, textDecoration: "none", padding: "8px 18px", borderRadius: 9, boxShadow: "0 2px 8px rgba(0,62,199,0.3)" }}>Kostenlos starten →</a>
        </div>
        <MobileNav />
      </nav>
      ...
      <section style={{ maxWidth: 1200, margin: "0 auto", padding: "80px 32px 64px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center" }} className="kf-hero-grid">
        <div>
          ...
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
            <a href="/signup/buyer" className="kf-cta-btn" style={{ background: ORANGE, color: "#fff", padding: "14px 26px", borderRadius: 12, fontWeight: 700, fontSize: 15, textDecoration: "none", boxShadow: "0 4px 16px rgba(0,62,199,0.3)" }}>Als Kiosk starten →</a>
        ...
        <div className="kf-hero-visual" style={{ display: "flex", flexDirection: "column", gap: 0 }} aria-hidden="true">
          <div style={{ background: "var(--kf-surface)", border: "1px solid var(--kf-border)", borderRadius: 16, padding: "18px 20px", display: "flex", alignItems: "center", gap: 14 }}>
            <div style={{ width: 44, height: 44, background: "#003ec718", borderRadius: 12, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
          ...
          <div style={{ background: ORANGE, borderRadius: 16, padding: "20px", display: "flex", alignItems: "center", gap: 14 }}>
            ...
            <div style={{ textAlign: "right", flexShrink: 0 }}>
              <p style={{ fontFamily: "'Inter',sans-serif", fontWeight: 800, fontSize: 20, color: "#fff", fontVariantNumeric: "tabular-nums" }}>€47.70</p>
